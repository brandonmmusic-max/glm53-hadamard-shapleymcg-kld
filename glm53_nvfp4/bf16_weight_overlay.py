...
def build(carrier: Path, output: Path, chunks: list[Path], layers: set[int]) -> dict:
...
def main() -> None:
    ...
    print(json.dumps(build(args.carrier, args.output, args.chunk, set(args.layers)), sort_keys=True))
