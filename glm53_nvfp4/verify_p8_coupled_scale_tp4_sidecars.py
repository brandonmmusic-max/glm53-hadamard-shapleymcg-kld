...
from .build_p8_coupled_scale_tp4_sidecars import (
    _load_rank_coupled,
    _payload_rates,
    _rank_metadata,
)
...
def verify_postwrite(
    *,
    ...
    if (
        ...
        or packer.get("weight_payload_bpw") != 4.25
    ...
    for rank, sidecar in enumerate(sidecars):
        ...
        expected, sources, design_sha256, scale_source_sha256 = _load_rank_coupled(
            chunks,
            layer=layer,
            rank=rank,
            world_size=4,
