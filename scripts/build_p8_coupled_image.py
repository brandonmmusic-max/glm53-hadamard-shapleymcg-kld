...
TAG = "klc/glm53-p8-coupled:v2"
INTEGRATION_BASE = "53e0b45c57b9946ae3a7ef5dbdc376400d9a1a96"
...
def load_manifest() -> dict[str, object]:
    ...
    if manifest["schema"] != "glm53.p8-coupled-image-sources.v2":
...
def preflight(*, output_dir: Path, source_commit: str, tag: str) -> dict[str, object]:
    ...
    return {
        "schema": "glm53.p8-coupled-image-build.v2",
        "status": "prepared",
