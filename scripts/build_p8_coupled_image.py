...
TAG = "klc/glm53-p8-coupled:v7"
INTEGRATION_BASE = "dd9fcd9588ea2d428ac68de57655861b69c89a0a"
...
def load_manifest() -> dict[str, object]:
    ...
    if manifest["schema"] != "glm53.p8-coupled-image-sources.v7":
...
def preflight(*, output_dir: Path, source_commit: str, tag: str) -> dict[str, object]:
    ...
    return {
        "schema": "glm53.p8-coupled-image-build.v7",
        "status": "prepared",
...
def execute(plan: dict[str, object], output_dir: Path) -> None:
    ...
    required_labels = {
        "org.klc.experiment": "glm53-p8-coupled-h512-h128-suh-svh-v7",
