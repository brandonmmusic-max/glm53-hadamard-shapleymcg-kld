...
TAG = "klc/glm53-p8-coupled:v6"
INTEGRATION_BASE = "c7388f2b685826b94ed84c128cdefb2046df290e"
...
def load_manifest() -> dict[str, object]:
    ...
    if manifest["schema"] != "glm53.p8-coupled-image-sources.v6":
...
def preflight(*, output_dir: Path, source_commit: str, tag: str) -> dict[str, object]:
    ...
    return {
        "schema": "glm53.p8-coupled-image-build.v6",
        "status": "prepared",
...
def execute(plan: dict[str, object], output_dir: Path) -> None:
    ...
    required_labels = {
        "org.klc.experiment": "glm53-p8-coupled-h512-h128-suh-svh-v6",
