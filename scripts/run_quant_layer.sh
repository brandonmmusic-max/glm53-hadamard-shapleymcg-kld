...
# Capture transport does not use the GPUs or production model state. Enter the
# maintenance window only after the immutable layer inputs are local and verified.
exec 9>"$LOCK"
flock -w 900 9
