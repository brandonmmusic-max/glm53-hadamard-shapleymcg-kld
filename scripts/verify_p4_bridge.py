...
def main():
    ...
    result = {"schema": "glm53-p4-serving-bridge-structural-receipt.v2",
              ...
              "proven": ["native-RNE state labels including signed zero", "six-tensor TP4 export and exact charged globals",
                         ...
                         "materialized fit capture exact path/bytes/SHA-256 rejects substitution/corruption",
                         "one immutable design binds exact materialized capture files separately for every declared layer"],
