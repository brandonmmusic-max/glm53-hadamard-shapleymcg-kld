...
FREEZE=$EVIDENCE/rotation-wave1-freeze.json
...
if ! stage_recorded rotation-wave1-frozen; then
  python3 -m glm53_nvfp4.stage_receipt "$RECORD" --stage rotation-wave1-frozen \
