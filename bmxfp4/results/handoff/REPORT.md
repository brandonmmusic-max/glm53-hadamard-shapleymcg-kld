...
| B5h | W4A16 | 0.00868 | 0.9681 | 0.105 | 16 | B5r | -0.00055 [-0.00112, -0.00001] * |
| B5h | W4A4 | 0.02849 | 0.9460 | 0.248 | 16 | B5r | +0.01926 [+0.01575, +0.02280] * |
| B5p | W4A16 | 0.01050 | 0.9639 | 0.129 | 16 | B5 | +0.00072 [+0.00011, +0.00145] * |
| B5r | W4A16 | 0.00923 | 0.9671 | 0.107 | 16 | B3p | -0.00227 [-0.00351, -0.00115] * |
| B5r | W4A4 | 0.02079 | 0.9463 | 0.233 | 16 | B3p | +0.00929 [+0.00661, +0.01166] * |
...
| S1-nvidia | W4A16 | 0.02741 | 0.9445 | 0.319 | 16 | E1b | +0.02094 [+0.01571, +0.02587] * |
| S1-nvidia | W4A4 | 0.04604 | 0.9236 | 0.536 | 16 | E1b | +0.03957 [+0.03004, +0.04828] * |
| S1-nvidia-experts | W4A16 | 0.01438 | 0.9600 | 0.160 | 16 | B5r | +0.00515 [+0.00348, +0.00693] * |
| S1-nvidia-experts | W4A4 | 0.02406 | 0.9435 | 0.277 | 16 | B5r | +0.01483 [+0.01105, +0.01852] * |
| S2-redhat | W4A16 | 0.02713 | 0.9425 | 0.323 | 16 | E1b | +0.02066 [+0.01562, +0.02537] * |
| S2-redhat | W4A4 | 0.04601 | 0.9238 | 0.561 | 16 | E1b | +0.03954 [+0.02996, +0.04841] * |
| S2-redhat-experts | W4A16 | 0.01451 | 0.9591 | 0.163 | 16 | B5r | +0.00528 [+0.00365, +0.00700] * |
| S2-redhat-experts | W4A4 | 0.02385 | 0.9446 | 0.276 | 16 | B5r | +0.01462 [+0.01085, +0.01819] * |
...
| B5h | W4A16 | 0.01119 | 0.9671 | 0.165 | 25 | B5r | -0.00034 [-0.00078, +0.00009] |
| B5h | W4A4 | 0.03308 | 0.9449 | 0.363 | 25 | B5r | +0.02155 [+0.01824, +0.02549] * |
| B5r | W4A16 | 0.01152 | 0.9674 | 0.173 | 25 | B3p | -0.00217 [-0.00278, -0.00161] * |
| B5r | W4A4 | 0.02476 | 0.9468 | 0.349 | 25 | B3p | +0.01106 [+0.00843, +0.01405] * |
...
| S1-nvidia | W4A16 | 0.03157 | 0.9439 | 0.425 | 25 | E1b | +0.02449 [+0.01864, +0.03135] * |
| S1-nvidia | W4A4 | 0.05389 | 0.9251 | 0.754 | 25 | E1b | +0.04681 [+0.03616, +0.05858] * |
| S1-nvidia-experts | W4A16 | 0.01628 | 0.9605 | 0.217 | 25 | B5r | +0.00476 [+0.00346, +0.00601] * |
| S1-nvidia-experts | W4A4 | 0.02696 | 0.9468 | 0.369 | 25 | B5r | +0.01543 [+0.01265, +0.01814] * |
| S2-redhat | W4A16 | 0.03127 | 0.9434 | 0.428 | 25 | E1b | +0.02420 [+0.01859, +0.03034] * |
| S2-redhat | W4A4 | 0.05392 | 0.9258 | 0.741 | 25 | E1b | +0.04685 [+0.03584, +0.05900] * |
| S2-redhat-experts | W4A16 | 0.01613 | 0.9610 | 0.204 | 25 | B5r | +0.00460 [+0.00319, +0.00594] * |
| S2-redhat-experts | W4A4 | 0.02761 | 0.9463 | 0.370 | 25 | B5r | +0.01608 [+0.01308, +0.01919] * |
...
| B5h | W4A16 | 0.01953 | 0.9487 | 0.258 | 10 | B5r | -0.00065 [-0.00145, +0.00018] |
| B5h | W4A4 | 0.04821 | 0.9197 | 0.499 | 10 | B5r | +0.02802 [+0.02578, +0.03034] * |
| B5r | W4A16 | 0.02018 | 0.9476 | 0.248 | 10 | B3p | -0.00318 [-0.00430, -0.00213] * |
| B5r | W4A4 | 0.04169 | 0.9193 | 0.477 | 10 | B3p | +0.01833 [+0.01615, +0.02059] * |
...
| S1-nvidia | W4A16 | 0.04058 | 0.9210 | 0.451 | 10 | E1b | +0.03123 [+0.02853, +0.03374] * |
| S1-nvidia | W4A4 | 0.07163 | 0.8973 | 0.772 | 10 | E1b | +0.06229 [+0.05788, +0.06647] * |
| S1-nvidia-experts | W4A16 | 0.02223 | 0.9430 | 0.254 | 10 | B5r | +0.00204 [+0.00093, +0.00320] * |
| S1-nvidia-experts | W4A4 | 0.03782 | 0.9212 | 0.451 | 10 | B5r | +0.01763 [+0.01587, +0.01920] * |
| S2-redhat | W4A16 | 0.04025 | 0.9225 | 0.422 | 10 | E1b | +0.03091 [+0.02790, +0.03415] * |
| S2-redhat | W4A4 | 0.06921 | 0.8983 | 0.733 | 10 | E1b | +0.05987 [+0.05559, +0.06434] * |
| S2-redhat-experts | W4A16 | 0.02231 | 0.9407 | 0.256 | 10 | B5r | +0.00213 [+0.00118, +0.00309] * |
| S2-redhat-experts | W4A4 | 0.03891 | 0.9208 | 0.466 | 10 | B5r | +0.01872 [+0.01759, +0.01996] * |
...
## Stock NVFP4 anchors (B1/B2 of the plan): dequantized through the same harness; final role W4A16 unless stated
Scopes: `full` = every quantized Linear installed (attention + experts, as shipped); `-experts` = routed experts only, attention BF16 (the scope of every BMXFP4 arm). Routed-expert bytes of stock NVFP4 = 4.500 bpw = B5r; B7n carries 5.029 bpw.
- S1-nvidia vs E1b: 0.03157 vs 0.00707 (ratio 4.46x; diff +0.02449, 95% CI [+0.01864, +0.03135], excludes 0)
- S1-nvidia-experts vs E1b: 0.01628 vs 0.00707 (ratio 2.30x; diff +0.00921, 95% CI [+0.00702, +0.01193], excludes 0)
- S1-nvidia-experts vs E1b-experts: 0.01628 vs 0.00523 (ratio 3.11x; diff +0.01105, 95% CI [+0.00847, +0.01412], excludes 0)
- B5r (uniform NVFP4 Had16 GPTQ REAP, same bytes) vs S1-nvidia-experts: 0.01152 vs 0.01628 (ratio 0.71x; diff -0.00476, 95% CI [-0.00601, -0.00346], excludes 0)
- B7n (Shapley multi-tier, +0.53 bpw) vs S1-nvidia-experts: 0.00900 vs 0.01628 (ratio 0.55x; diff -0.00728, 95% CI [-0.00859, -0.00600], excludes 0)
- B7 (main run, 4:8 tier) vs S1-nvidia-experts: 0.01372 vs 0.01628 (ratio 0.84x; diff -0.00256, 95% CI [-0.00545, +0.00091], includes 0)
- W4A4: S1-nvidia full A4 vs S1-nvidia full A16: 0.05389 vs 0.03157 (ratio 1.71x; diff +0.02232, 95% CI [+0.01732, +0.02754], excludes 0); S1-nvidia-experts A4: 0.02696 vs 0.01628 (ratio 1.66x; diff +0.01067, 95% CI [+0.00811, +0.01349], excludes 0)
- [selection] S1-nvidia-experts vs E1b: 0.01438 vs 0.00647 (ratio 2.22x; diff +0.00791, 95% CI [+0.00580, +0.01011], excludes 0); B5r vs S1-nvidia-experts: 0.00923 vs 0.01438 (ratio 0.64x; diff -0.00515, 95% CI [-0.00693, -0.00348], excludes 0); [wikitext] B5r vs S1-nvidia-experts: 0.02018 vs 0.02223 (ratio 0.91x; diff -0.00204, 95% CI [-0.00320, -0.00093], excludes 0)
- S2-redhat vs E1b: 0.03127 vs 0.00707 (ratio 4.42x; diff +0.02420, 95% CI [+0.01859, +0.03034], excludes 0)
- S2-redhat-experts vs E1b: 0.01613 vs 0.00707 (ratio 2.28x; diff +0.00906, 95% CI [+0.00684, +0.01193], excludes 0)
- S2-redhat-experts vs E1b-experts: 0.01613 vs 0.00523 (ratio 3.08x; diff +0.01090, 95% CI [+0.00830, +0.01411], excludes 0)
- B5r (uniform NVFP4 Had16 GPTQ REAP, same bytes) vs S2-redhat-experts: 0.01152 vs 0.01613 (ratio 0.71x; diff -0.00460, 95% CI [-0.00594, -0.00319], excludes 0)
- B7n (Shapley multi-tier, +0.53 bpw) vs S2-redhat-experts: 0.00900 vs 0.01613 (ratio 0.56x; diff -0.00713, 95% CI [-0.00855, -0.00571], excludes 0)
- B7 (main run, 4:8 tier) vs S2-redhat-experts: 0.01372 vs 0.01613 (ratio 0.85x; diff -0.00240, 95% CI [-0.00537, +0.00118], includes 0)
- W4A4: S2-redhat full A4 vs S2-redhat full A16: 0.05392 vs 0.03127 (ratio 1.72x; diff +0.02265, 95% CI [+0.01718, +0.02875], excludes 0); S2-redhat-experts A4: 0.02761 vs 0.01613 (ratio 1.71x; diff +0.01148, 95% CI [+0.00858, +0.01487], excludes 0)
- [selection] S2-redhat-experts vs E1b: 0.01451 vs 0.00647 (ratio 2.24x; diff +0.00805, 95% CI [+0.00596, +0.01028], excludes 0); B5r vs S2-redhat-experts: 0.00923 vs 0.01451 (ratio 0.64x; diff -0.00528, 95% CI [-0.00700, -0.00365], excludes 0); [wikitext] B5r vs S2-redhat-experts: 0.02018 vs 0.02231 (ratio 0.90x; diff -0.00213, 95% CI [-0.00309, -0.00118], excludes 0)

## W4A4 lever: full-width Hadamard (QuaRot-style, 2048 on expert inputs, 12x64 Kronecker on down_proj inputs) vs block-16 Hadamard, uniform NVFP4, GPTQ, REAP Hessians
- B5h vs B5r W4A16: 0.01119 vs 0.01152 (ratio 0.97x; diff -0.00034, 95% CI [-0.00078, +0.00009], includes 0)
- B5h vs B5r W4A4: 0.03308 vs 0.02476 (ratio 1.34x; diff +0.00832, 95% CI [+0.00692, +0.00970], excludes 0)
