...
Dated narrative of the GLM-5.3-Flash quantization campaign. The
[README](../README.md) states what is currently true; this file records how each
result was reached, including attempts that were superseded or failed.

Result labels follow the README: **Qualified**, **Developmental**, **Failed
gate**, **Superseded**. Text below is preserved from the running record.
