...
class safe_open:
    ...
    def __init__(self, filename: Union[str, list[str]], framework: str,
        ...
        # [overlay] Weight swaps (e.g. TrellisMX carrier release) return memory to
        # torch's caching allocator only; the CUDA driver still sees it mapped.
        # The loader ring buffer below is a raw cudaMalloc (loader_common.cpp) that
        # must fit in driver-free VRAM, so force torch to unmap/free cached blocks
        # before measuring availability and allocating.
