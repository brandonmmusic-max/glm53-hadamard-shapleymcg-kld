...
|---|---:|---:|
| 0K C4 decode aggregate | 327.670 | 92.3 |

KV capacity: 23,568,627 tokens. NCCL8 channels verified from logs. Unchanged selected FP8 token-map-hoist image, TP4/DCP4/MTP3, graphs, NVFP4KV, maxseq24, batch4096, four300W GPUs.
